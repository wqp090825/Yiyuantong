...
//     console.log(window.localStorage)
        history.push({
            pathname:'/goodlist/'+lists.goods_id,
            state:lists
        });
    }
	...
	render(){
        ...
        >
          {this.state.banner.map(item => (
            <div style={{ width: '375px', verticalAlign: 'top',height:'185px' }}>
            <a
              key={item.mid}
              href="#"
              style={{width: '100%' }}
				...
				<div className="nav">
					<div className='navimg'>
							<ul>
								...
								<li className='nav-li-three'><NavLink to='/goods' >
				...
				<div className='loadmore'>
					...
					<div className='gongge'>
						<Grid
				            ...
				            itemStyle={{height:'278px'}}
				            renderItem={(lists,idx)=>{
				                return(
				                    <div className="goods-item">
				                        <img src={lists.goods_thumb} />
				                        <p>{lists.goods_name}</p>
				                         <h3>{lists.shop_price}</h3>
				                    </div>
				                )
				            }}
